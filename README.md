...
| J37 | `NX_DISPLAY_PERF\<timestamp>\REPORTS\J37_{TARGETS,OCCURRENCES,LAYERS,VISIBLE,PREFS,SUSPECTS,TIMING}_<timestamp>.csv`, `J37_EVIDENCE_<timestamp>.json`, and `LOGS\J37_LOG_<timestamp>.txt` |
